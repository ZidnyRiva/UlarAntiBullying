...
let questionIndex = 0;
const questions = [
    { question: "Perundungan (bullying) adalah saat seseorang menyakiti atau mengganggu orang lain berulang kali.", correct: ["Benar"] },
    { question: "Perundungan (bullying) terjadi hanya di sekolah.", correct: ["Salah"] },
    { question: "Anak-anak yang dirundung (dibully) sering merasa sedih dan tidak percaya diri.", correct: ["Benar"] },
    { question: "Hanya anak-anak yang lebih besar yang bisa menjadi pelaku perundungan (bullying).", correct: ["Salah"] },
    { question: "Jika kamu melihat temanmu dirundung (dibully), sebaiknya kamu tidak peduli dan pergi saja.", correct: ["Salah"] },
    { question: "Menghargai perbedaan dan bersikap baik kepada teman dapat membantu mencegah perundungan (pembullyan).", correct: ["Benar"] },
    { question: "Perundungan (pembullyan) fisik adalah satu-satunya jenis perundungan yang ada.", correct: ["Benar"] },
    { question: "Berkata kasar dan mengejek kepada teman adalah salah satu bentuk perundungan (bullying) verbal.", correct: ["Benar"] },
    { question: "Mengirim pesan atau berkomentar jahat termasuk pada perundungan (pembullyan).", correct: ["Benar"] },
    { question: "Jika kamu pernah dirundung (dibully), penting untuk bercerita kepada orang yang lebih dewasa yang kamu percayai, seperti guru atau orang tua.", correct: ["Benar"] }
];
...
function askQuestion() {
    ...
    ["Benar", "Salah", "Tidak Tahu"].forEach((option) => {
